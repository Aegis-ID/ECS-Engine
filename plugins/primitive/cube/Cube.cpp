...
std::string Cube::getAuthor() const
{
    return "Paul";
}

std::string Cube::getDescription() const
{
    return "Cube Plugin";
}

Engine::Version Cube::getVersion() const
{
    return {1, 0, 0};
}

Engine::Entity::EntityType Cube::getEntityType() const
{
    return Engine::Entity::EntityType::PRIMITIVE;
}

Engine::System::SystemType Cube::getSystemType() const
{
    return Engine::System::SystemType::UNKNOWN;
}

ECS::Signature Cube::getEntitySignature() const
{
    return _signature;
}

bool Cube::initialize(std::shared_ptr<Engine::Scene> scene)
{
...
std::vector<Engine::EntityFactoryInfo> Cube::getEntityFactories()
{
    return {
        {
            getName(),
            ...
            [](Engine::Scene &scene, const Engine::Entity::EntityConfig &config)
            {
                ...
                entity->addComponent<Engine::CoreComponents::EntityInfo>("cube", Engine::Entity::EntityType::PRIMITIVE);
...
std::vector<Engine::SystemFactoryInfo> Cube::getSystemFactories()
{
    return {};
}

void Cube::configureSystems(std::shared_ptr<Engine::Scene> scene)
{
    (void)scene;
}
