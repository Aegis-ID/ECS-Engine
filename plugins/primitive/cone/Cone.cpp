...
std::string Cone::getAuthor() const
{
    return "Paul";
}

std::string Cone::getDescription() const
{
    return "Cone Plugin";
}

Engine::Version Cone::getVersion() const
{
    return {1, 0, 0};
}

Engine::Entity::EntityType Cone::getEntityType() const
{
    return Engine::Entity::EntityType::PRIMITIVE;
}

Engine::System::SystemType Cone::getSystemType() const
{
    return Engine::System::SystemType::UNKNOWN;
}

ECS::Signature Cone::getEntitySignature() const
{
    return _signature;
}

bool Cone::initialize(std::shared_ptr<Engine::Scene> scene)
{
...
std::vector<Engine::EntityFactoryInfo> Cone::getEntityFactories()
{
    return {
        {
            getName(),
            ...
            [](Engine::Scene &scene, const Engine::Entity::EntityConfig &config)
            {
                ...
                entity->addComponent<Engine::CoreComponents::EntityInfo>("cone", Engine::Entity::EntityType::PRIMITIVE);
...
std::vector<Engine::SystemFactoryInfo> Cone::getSystemFactories()
{
    return {};
}

void Cone::configureSystems(std::shared_ptr<Engine::Scene> scene)
{
    (void)scene;
}
